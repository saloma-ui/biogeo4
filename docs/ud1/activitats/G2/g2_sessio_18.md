...
[Continua amb la Sessió 19](g2_sessio_19.md)
...
### Indicadors observables en aquesta sessió
...
- Identifica elements exposats i factors de vulnerabilitat.
- Compara A, B i C amb evidències concretes procedents de diversos mapes.
- Formula una primera proposta territorial científicament defensable.

**CA 4.2**
- Formula una **decisió inicial explícita** que es conservarà com a punt de partida per poder observar la revisió posterior.

### Evidències que convé conservar

1. Taula d’anàlisi dels mapes 1–4.
2. Resposta sobre perill, exposició, vulnerabilitat i risc.
3. Ordre inicial A–B–C.
4. Primera decisió i justificació.
5. Inconvenient reconegut i mesura preventiva proposada.
